...
$(document).ready(function () {
    ...
    $("#searchBtn").click(function () {
        var query_param_shouRuXiaoLei_name = $("#query_param_shouRuXiaoLei_name").val();
        $.ajax({
            url: "/querySRXiaoLeiByNameWithLike",
            type: "GET",
            data: {name: query_param_shouRuXiaoLei_name},
            ...
            success: function (data, textStatus) {
                if (data.success) {
                    ...
                    $.each(data.data, function (id, shouRuXiaoLei) {
                        var $tr = $("<tr ></tr>");
                        var $td1 = $("<td >" + shouRuXiaoLei.id + "</td>");
                        var $td2 = $("<td >" + shouRuXiaoLei.name + "</td>");
                        var $td3 = $("<td >" + shouRuXiaoLei.daLeiName + "</td>");
                        var $td4 = $("<td><a class='deleteObjectLinkClass' href='#' name='" + shouRuXiaoLei.name +
                            "' institution_code = '" + shouRuXiaoLei.institution_code + "'  id = '" + shouRuXiaoLei.id + "'   >删除</a></td>");
