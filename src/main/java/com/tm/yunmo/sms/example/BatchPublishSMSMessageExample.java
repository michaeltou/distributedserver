package com.tm.yunmo.sms.example;
...
public class BatchPublishSMSMessageExample {
    ...
    public static void main(String[] args) {
        ...
        batchSmsAttributes.setFreeSignName("云模网络");
        // 3.2 设置发送短信使用的模板（SMSTempateCode）
        batchSmsAttributes.setTemplateCode("SMS_66480046");
        // 3.3 设置发送短信所使用的模板中参数对应的值（在短信模板中定义的，没有可以不用设置）
        BatchSmsAttributes.SmsReceiverParams smsReceiverParams = new BatchSmsAttributes.SmsReceiverParams();
        smsReceiverParams.setParam("customer", "michael");

        // 3.4 增加接收短信的号码
        batchSmsAttributes.addSmsReceiver("18658160158", smsReceiverParams);
