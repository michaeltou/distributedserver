...
public interface SchoolDAO {
    ...
    @Insert("insert into px_school(select id,schoolName,schoolCode,address,phone,xiaoQuCode,principalName,principalSFZCode,createDate,updateDate,type) values " +
