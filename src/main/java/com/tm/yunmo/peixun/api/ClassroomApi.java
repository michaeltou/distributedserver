...
public class ClassroomApi {
    ...
    public List<Classroom> queryClassroomListByInstitutionAndSchoolName(HttpServletRequest request) {
        ...
        @RequestMapping("/queryClassroomListByNameWithLike")
    public ResultModel queryClassroomListByNameWithLike(HttpServletRequest request) {
         ResultModel resultModel = new ResultModel(); 
        String institution_code = (String) request.getSession().getAttribute("institution_code");
        String name = request.getParameter("name");
        List<Classroom> classroomList = classroomService.queryClassroomListByNameWithLike(institution_code, name);
        resultModel.setData(classroomList);
        return resultModel;
    }
    ...
    public ResultModel insertClassroom(@RequestBody Classroom classroom, HttpServletRequest request) {
        ResultModel resultModel = new ResultModel();
        String institution_code = (String) request.getSession().getAttribute("institution_code");
        classroom.setInstitution_code(institution_code);
    ...
    public ResultModel updateClassroom(@RequestBody Classroom classroom, HttpServletRequest request) {
        ResultModel resultModel = new ResultModel();
    ...
    public ResultModel deleteClassroom(@RequestBody Classroom classroom, HttpServletRequest request) {
        ResultModel resultModel = new ResultModel();
        String institution_code = (String) request.getSession().getAttribute("institution_code");
        classroom.setInstitution_code(institution_code);
